...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp = getSharedPreferences("MY_WIRELESS_SETTING", MODE_PRIVATE);
        batteryState = (TextView) findViewById(R.id.txt_battery_status);
        wifiState = (Switch) findViewById(R.id.swt_wifi_state);
        swtAirPlane = (Switch) findViewById(R.id.swt_flightMode_state);
        sharedPreferenceName = (TextView) findViewById(R.id.txt_SharePreference);
        // wifi swtting
        sharedPreferenceName.setText(sp.getString("SP_NAMES", ""));
    ...
    BroadcastReceiver batteryReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Intent.ACTION_BATTERY_OKAY)) {
                ...
                batteryState.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
            }
            if (intent.getAction().equals(Intent.ACTION_BATTERY_LOW)) {
                batteryState.setText("Battery Status:  LOW");
                Log.d("MYTAG", "onReceive: low");
                batteryState.setBackgroundColor(getResources().getColor(R.color.colorAccent));
            }
        }
